    ...
    <div className="apple-card p-5">
      ...
      <div className="flex items-center gap-2.5 mb-4">
        ...
        <div>
          ...
          <p className="text-[11px] text-text-400">设置贷款基本信息，实时计算结果</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <label className="text-[12px] font-medium text-text-600">贷款总额</label>
          ...
          <div className="apple-field">
            <input
              ...
              className="apple-input font-mono font-semibold text-[16px] tabular-nums"
              placeholder="100"
              step="5"
            />
          </div>
          <div className="flex gap-1 flex-wrap">
            {quickAmounts.map((amt) => (
              <button
                ...
                className={`px-2 py-0.5 rounded-full text-[10px] font-semibold transition font-mono ${
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <label className="text-[12px] font-medium text-text-600 flex items-center gap-1">
              <Percent className="w-3 h-3 text-text-400" />
              年利率
            </label>
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <label className="text-[12px] font-medium text-text-600 flex items-center gap-1">
              <Calendar className="w-3 h-3 text-text-400" />
              贷款期限
            </label>
        ...
        <div className="space-y-2">
          <label className="text-[12px] font-medium text-text-600 flex items-center gap-1">
            <CalendarDays className="w-3 h-3 text-text-400" />
            贷款起始日
          </label>
          <div className="apple-field">
            <input
              ...
              className="apple-input font-mono font-medium text-[14px] flex-1"
            />
          </div>
          <div className="h-4" />
        </div>
        ...
        <div className="space-y-2">
          <label className="text-[12px] font-medium text-text-600 flex items-center gap-1">
            <Repeat className="w-3 h-3 text-text-400" />
            还款方式
          </label>
          ...
          <p className="text-[11px] text-text-400 leading-relaxed">
